...
// Article data (variables that the HTML requires)
$article = [
    'id' => $id,
    'title' => '',
    'summary' => '',
...
if ($id) {
    $sql = "SELECT a.id, a.title, a.summary, a.content, a.member_id, a.category_id, a.image_id, a.published, 
            i.file AS image_file,
            i.alt AS image_alt
            FROM article AS a
            LEFT JOIN image as i ON a.image_id = i.id
            WHERE a.id = :id;"; // The :id is a named placeholder for a parameter that will be provided when the query is executed.
